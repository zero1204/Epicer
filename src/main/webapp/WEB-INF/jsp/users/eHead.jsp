<%@ page  import="com.epicer.model.*" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		<!-- (Header)Start 上方 Navbar 上方 (要思考是否加裝在個人頁面) -->
		<nav
			...
			<div class="container-fluid py-1 px-3">
				...
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<ul class="navbar-nav  justify-content-end">
						...
						<a href="adminlogout" class="nav-link text-white font-weight-bold px-0"> 
										...
										<div class="d-flex py-1">
											...
											<div class="d-flex flex-column justify-content-center">
												<h6 class="text-sm font-weight-normal mb-1">
													<span class="font-weight-bold">${welcome}</span> from Laur
												</h6>
